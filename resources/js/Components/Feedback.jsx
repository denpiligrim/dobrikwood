...
const Feedback = () => {
    ...
    const ViberIcon = createSvgIcon(
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 631.99 666.43">
            ...
            />
            <path className="cls-2" d="M389.47,268.77q-2.46-49.59-50.38-52.09" />
            <path className="cls-2" d="M432.72,283.27q1-46.2-27.37-77.2c-19-20.74-45.3-32.16-79.05-34.63" />
            <path className="cls-2" d="M477,300.59q-.61-80.17-47.91-126.28t-117.65-46.6" />
            <path
                className="cls-1"
